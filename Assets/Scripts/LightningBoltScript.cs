...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        public GameObject StartObject0;
        public GameObject StartObject1;
        ...
        private void Start()
        {
            EndObject = EndObject0;
            StartObject = StartObject0;
        ...
        private void Update() { 
            ...
            if (!activated) {
                StartObject = StartObject1;
                EndObject = EndObject1;
            }
                orthographic = (Camera.main != null && Camera.main.orthographic);
                if (timer <= 0.0f)
                {
